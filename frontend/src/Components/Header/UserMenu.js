                ...
                <Paper>
                  <ClickAwayListener onClickAway={this.handleClose}>
                    <MenuList className={classes.menuList}>
                      <MenuItem className={classes.profileMenuItem} onClick={this.handleClose} size='large'>
                        <div className={classes.profile}>
                          ...
                          <div className={classes.profileContent}>
                            <div className={classes.name}>{currentUser.docs && currentUser.docs[0].firstName.concat(' ', currentUser.docs[0].lastName)}</div>
                            <div className={classes.email}>{currentUser.docs && currentUser.docs[0].emailAddress}</div>
                          </div>
                        </div>
                      </MenuItem>
                      <Divider />
